package com.ssdjr2.own.sbc.tool.library_commons.utils;
...
public class UConstants {
	...
	public static final String REGEX_ADDITIONAL_INFO = "^[A-Z]{1}[a-zñA-Záéíóú\\s\\.\\_\\-,;()¿?!¡=\\d]{3,2500}";
	...
	// - REG_EXP : CONTACT
	public static final String REGEX_PHONE = "^(\\+34|0034|34)?[6789]\\d{8}$";
}
